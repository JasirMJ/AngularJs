<!DOCTYPE html>  
      ...
      <body>  
           ...
           <div class="container" ng-app="myapp" ng-controller="myController" ng-init="select()">  
                ...
                <div class="col-md-6">  
                     ...
                     <button class="btn btn-info" ng-click="demofn()">check button</button>  
                </div>  
 ...
 // must specify this to upload files using angularjs
 ...
 app.controller("myController", function($scope, $http){  
      ...
      $scope.demofn = function(){
          var form_data = new FormData();  
          var daa = {
               "function":"olakka",// just to specify which function want run
